...
l=tk.Label(root,text="Enter marks of subject 1 (out of 100):",bg="#f2f2f2",font=label_font)
...
l1=tk.Label(root,text="Enter marks of subject 2 (out of 100):",bg="#f2f2f2",font=label_font)
...
l2=tk.Label(root,text="Enter marks of subject 3 (out of 100):",bg="#f2f2f2",font=label_font)
