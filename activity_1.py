...
l=tk.Label(root,text="Enter marks of subject 1 (out of 100):",bg="sky blue",font=label_font)
...
l1=tk.Label(root,text="Enter marks of subject 2 (out of 100):",bg="sky blue",font=label_font)
...
l2=tk.Label(root,text="Enter marks of subject 3 (out of 100):",bg="sky blue",font=label_font)
...
def disp():
	...
	if(0<t<=100 and 0<t1<=100 and 0<t2<=100):
		result.config(text="Total Marks:"+str(t+t1+t2))
		avg=int((t+t1+t2)/3)
		result1.config(text="Average:"+str(avg))
		if(avg>=35):
			if(avg>=90):
...
button=tk.Button(root,text="Click me",command=disp,font=btn_font,bg="dark blue",fg="white",padx=20)
button.grid(row=4,column=0,columnspan=2,pady=15)
result=tk.Label(root,text="",bg="sky blue",font="label_font")
result.grid(row=5,column=0,sticky="w",padx=20)
result1=tk.Label(root,text="",bg="sky blue",font="label_font")
result1.grid(row=6,column=0,sticky="w",padx=20)
result2=tk.Label(root,text="",bg="sky blue",font=("Arial",12,"bold"))
